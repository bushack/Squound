...
//{
//    internal class LoadingState : IState<SortAndFilterViewModel>
//    {
//        public async Task Enter(SortAndFilterViewModel viewModel)
//        {
...
//                viewModel.previousQuery = new ProductQueryDto
//                {
...
//                var productList = await viewModel.ProductService.GetProductsRestApi(vm.CurrentQuery);
